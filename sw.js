 ...
 */
const CACHE_VERSION = "salishmap-shell-v30";   // 2026-08-28b: palette toggle — checkbox switches between CVD-safe (blue→amber) and standard (green→yellow→red) palettes for currents and wind; choice persists in localStorage.
