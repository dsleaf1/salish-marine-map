 ...
 */
const CACHE_VERSION = "salishmap-shell-v29";   // 2026-08-28a: CVD-SAFE PALETTES — CUR_COL and W_COL replaced with blue→amber ramps on the deuteranopia-safe axis; worst adjacent ΔE under deutan improved from 1.4→12.6 (currents) and 4.1→7.8 (wind).
